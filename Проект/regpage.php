    ...
    <div class="main-form">
        <div class="topColumn">
            ...
            <ul class="top-actions">
                ...
                <li class="menu-item">
                    <a href="regpage.php" class="menu-link">Регистрация</a>
                </li>
            </ul>
        </div>
        <div class="reg">
        ...
        <form id="main_info" action="inc/register2.php" method="post" enctype="multipart/form-data">
            <div class="reg-content">
                ...
                <div id="imageContainer" style="max-width: 650px;"></div>
                <div class="input-box-reg-text" style="font-size: 16px;">Ваши файлы</div>
                <div id="fileContainer" style="margin-bottom: 60px;"></div>

                <button class="btn-input btn-save" id="saveButton">
